...
const ClassesDetails = () => {
    ...
    return ( 
        <div>
            ...
            <div className='flex items-center gap-5 max-w-6xl mx-auto pt-20'>
          ...
          <button onClick={()=> navigate('/trainer')} className="bg-[#1e8332] px-6 py-2 rounded-md font-medium text-white p-2 text-xl hover:bg-[#05c21b]">
            Join Now
          </button>
          </div>
            </div>
