  ...
  return (
    <div>
      <div>
        ...
        <div className="absolute top-1/4 z-10 md:w-3/5  px-5 md:ml-16 md:pl-5 space-y-3 md:border-l-2 border-[#fe1313] text-center md:text-start">
          ...
          <button onClick={()=> navigate('/classes')} className="bg-[#fe1313] px-6 py-2 rounded-md font-medium text-white p-2 text-xl hover:bg-[#c20505]">
            Classes
          </button>
        </div>
