...
const Routers = createBrowserRouter([
        {
            ...
            children: [
                ...
                },
                {
                    ...
                    loader: ({params})=> fetch(`https://assignment12-server-side-ten.vercel.app/trainers/${params.id}`)
                },
                {
                    path: '/be-a-trainer',
                ...
                },
                {
                    ...
                    loader: ({params})=> fetch(`https://assignment12-server-side-ten.vercel.app/classes/${params.id}`)
                },
                {
                    path: '/community',
                    element: <Community/>
