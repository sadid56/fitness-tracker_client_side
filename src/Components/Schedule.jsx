    ...
    return ( 
        <div>
            ...
            <div className="max-w-3xl mx-auto shadow-md border rounded-md p-5">
                ...
                <Tabs>
                    <TabList className={`flex justify-center gap-5 cursor-pointer text-xl font-bold `}>
                        {
                    ...
                    <TabPanel className={"flex items-center gap-5 text-xl mt-10 font-semibold"}>
                    ...
                    <TabPanel className={"flex items-center gap-5 text-xl font-semibold"}>
                    ...
                    <TabPanel className={"flex justify-center items-center gap-5 text-xl font-semibold"}>
